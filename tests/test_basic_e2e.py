...
def _test_first_selected_second_not(selected: BtnContentPair, 
                                    not_selected: BtnContentPair) -> None:
    for sel in selected:
...
def test_page_nav(page: Page) -> None:
    ...
    home_button_content_pair = home_button, \
                               page.locator('#home')

    members_button_content_pair = members_button, \
                                  page.locator('#members')
